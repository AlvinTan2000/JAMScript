...
module.exports = function (cmdopts, jsys) {
    ...
    pack = {
        ...
        getClock: function () {
            ...
            let max = {clock: broadcasters[0].cloudClock, subClock: broadcasters[0].fogClock};
            for (let broadcaster of broadcasters) {
                if (broadcaster.cloudClock > max.clock || (broadcaster.cloudClock === max.clock && broadcaster.fogClock > max.subClock)) {
