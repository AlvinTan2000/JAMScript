// Listens for events in the key space and takes the required action.
...
module.exports = function(cmdopts, jsys)  {
    ...
    // Handler be passed to all instances of the JAMDatastream for making a call to the Redis server
    ...
    var parentRedis = null;         // For broadcasting
    var parentRedisLogger = null;   // For logging
